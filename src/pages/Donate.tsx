  ...
  const donatePackages: DonatePackage[] = [
    ...
    },
    {
      ...
      features: [
        ...
        '10 домов (/sethome)',
        'Скидка 15% в донат-магазине',
        'Приватные варпы (7 шт)',
        'Цветной чат'
      ],
      color: '#3b82f6',
    ...
    },
    {
      ...
      features: [
        ...
        'Команда /enderchest',
        'Доступ к /kit immortal',
        'Безлимит домов (/sethome)',
        'Скидка 50% в донат-магазине',
        'Безлимит приватных варпов',
        'Божественные эффекты',
        'VIP роль в Discord',
        'Личные ивенты от администрации',
        'Привилегия навсегда'
      ],
      color: '#ef4444',
